...
public class Scan_QR_For_Returning_Items extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.scan_qr_for_returning_items);

        surfaceView = findViewById(R.id.surfaceView);
        textQRValue = findViewById(R.id.ItemDetected);
        ReturnItemButton = findViewById(R.id.ReturnButton);
        ...
        ReturnItemButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent myIntent = new Intent(Scan_QR_For_Returning_Items.this, Add_Or_Remove_Item_From_A_User.class);
                myIntent.putExtra("Item",Data);
                myIntent.putExtra("Action","Return Item");
                Scan_QR_For_Returning_Items.this.startActivity(myIntent);
            }
        });
    ...
    private void initialiseDetectorAndSources() {
        ...
        surfaceView.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder holder) {
                try {
                    if (ActivityCompat.checkSelfPermission(Scan_QR_For_Returning_Items.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                        cameraSource.start(surfaceView.getHolder());
                    } else {
                        ActivityCompat.requestPermissions(Scan_QR_For_Returning_Items.this, new
    ...
    private void toastMessage(String text) {
        ...
        Toast.makeText(Scan_QR_For_Returning_Items.this, text,
